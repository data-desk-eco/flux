...
import { showDetail } from './vendor/cartograph/detail.js';
...
// each entry opens the nearest of its group in its own card — cartograph's own
// 10 px grouping then carries the rest through the header's overlap nav
